...
<body>
  ...
  <img src="<a href=""><img src="https://i.ibb.co/Xxv9RYf3/image.jpg" alt="Image" class="image">
 ...
 <button class="button-34" role="button" onclick="window.location.href='hosting.html'">CHECK</button>
    ...
    <div class="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
      ...
      <div id="links" class="flex space-x-4">
        <a href="https://www.facebook.com/profile.php?id=100031793539926" class="text-2xl hover:text-primary"><i class="fab fa-facebook"></i></a>
        <a href="https://wa.me/+9779844298980" class="text-2xl hover:text-primary"><i class="fab fa-whatsapp"></i></a>
        <a href="https://github.com/abhiidon" class="text-2xl hover:text-primary"><i class="fab fa-github"></i></a>
      </div>
